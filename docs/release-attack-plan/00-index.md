...
| **05** | [05-posthog.md](./05-posthog.md) | PostHog events + error tracking | **Public prod gate** — see [web/posthog-setup-report.md](../../web/posthog-setup-report.md) |
...
| 05 | done | PostHog EU + billing funnel events + error tracking — see web/posthog-setup-report.md |
| 06 | in progress | FirstPartyOnboarding — Luis finishing onboarding polish |
