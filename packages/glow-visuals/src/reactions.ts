...
export const EMOJI_GLYPHS: Record<ReactionEmoji, string> = {
  heart: '❤️',
  fire: '🔥',
  star: '⭐',
  clap: '👏',
...
export const REACTION_ALLOWLIST_FREE: ReactionEmoji[] = [
  'heart',
  'fire',
  'star',
  'clap',
...
// Paid plans get all
export const REACTION_ALLOWLIST_PAID: ReactionEmoji[] = [
  'heart',
  'fire',
  'star',
  'clap',
